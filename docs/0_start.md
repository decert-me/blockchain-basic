...
**第1篇：[区块链基础概念](/blockchain-basic/basic)**

在学习区块链之前，我们需要先了解一些密码学的基础概念。第1篇介绍了哈希函数、公钥密码学、数字签名、默克尔树等区块链技术的基石，理解这些概念将帮助你更好地理解后续章节的内容。

**第2篇：[比特币与区块链诞生](/blockchain-basic/bitcoin)**

在中本聪之前，几位大师对数字货币的探索，中本聪结合前人的探索及工作量证明的加入，诞生出第一个去中心化的数字货币：比特币。第2篇文章将了解比特币的基本原理和概念，包括区块、交易、挖矿等。

**第3篇：[比特币运行原理](/blockchain-basic/how_bitcoin_work)**
...
第6篇探讨了不同类型的区块链，包括公有链、私有链和联盟链等，以及它们各自的特点和适用场景。
...
区块链催生了新形态的应用，我们称之为 Web3 应用，Web3应用的特点是用户自己控制所有权。第8篇介绍了Web3的核心理念，以及IPFS、Filecoin等去中心化存储协议，它们是Web3应用的重要基础设施。
