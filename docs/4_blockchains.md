...
**Hyperledger Fabric**：由 Linux 基金会主导的开源联盟链框架，被广泛应用于企业级区块链解决方案。IBM、Oracle、SAP 等多家企业都参与了该项目的开发。

**R3 Corda**：专为金融服务行业设计的联盟链平台，全球超过300家金融机构参与其中，用于证券结算、贸易融资等场景。

**Quorum**：摩根大通开发的企业级以太坊，在保持以太坊兼容性的同时，增加了隐私保护和权限管理功能。

**蚂蚁链（AntChain）**：由蚂蚁集团开发的联盟链，应用于跨境汇款、供应链金融、电子票据等场景。

**长安链（ChainMaker）**：由北京微芯研究院、腾讯、百度等单位共同研发的国产联盟链，服务于政务、金融、能源等多个行业。
...
**公链 + 侧链**：主要资产在公链上，高频交易在侧链上处理，如比特币的闪电网络。
...
公链、私链和联盟链各有其适用场景，没有绝对的优劣之分。公链提供了最高程度的去中心化和透明性，适合需要全球共识的应用；私链提供了最高的性能和隐私性，适合企业内部使用；联盟链则在两者之间取得平衡，适合多方协作的商业场景。

随着区块链技术的发展，这三种类型的界限也在逐渐模糊，出现了更多灵活的混合方案，以满足不同的业务需求。
